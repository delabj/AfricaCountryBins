...
#' @rdname geom_africa_tilemap
#' @export
GeomAfricaTileMap <- ggplot2::ggproto(
  "GeomAfricaTileMap",
  ggplot2::Geom,
  ...
  setup_data = function(data, params){
    ...
    country_data <- validate_countries(
      country_data,
      "country",
      merge.x,
      ignore_dupes = TRUE)
    ...
    cntry.dat$width  <- cntry.dat$width  %||% params$width  %||% ggplot2::resolution(cntry.dat$x, FALSE)
    cntry.dat$height <- cntry.dat$height %||% params$height %||% ggplot2::resolution(cntry.dat$y, FALSE)
  ...
  draw_panel = function(
    ...
    ggname("geom_africa_tilemap", grid::grobTree(children = grobs))
  },
